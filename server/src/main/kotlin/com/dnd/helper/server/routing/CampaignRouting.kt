...
fun Application.configureCampaignRouting() {
    ...
    authenticate("auth-jwt") {
        ...
        post("/api/characters/assign") {
            ...
            println("[CampaignRouting] Assigning character ${body.characterId} in session ${body.sessionId} to user ${body.ownerUserId}")
            ...
            val result = transaction {
                ...
                if (existing == null) {
                    ...
                    println("[CampaignRouting] Assigned character to user ${body.ownerUserId} in session $charSessionId")
                    charSessionId
                }
            }
        ...
        post("/api/characters/assign-by-username") {
            ...
            when (result) {
                "USER_NOT_FOUND" -> call.respond(HttpStatusCode.NotFound, "User with username '${body.username}' not found")
